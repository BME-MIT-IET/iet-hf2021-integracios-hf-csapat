...
{
	[Binding]
	[Scope(Feature = "CycleSorter")]
	public sealed class CycleSorterStepDefinitions
	{
		private readonly ScenarioContext _scenarioContext;
		private List<int> _list = new List<int>();
		private Random _random;

		public CycleSorterStepDefinitions(ScenarioContext scenarioContext)
		{
		...
		{
			_list.CycleSortAscending<int>(Comparer<int>.Default);
		}

		[When("the list is sorted descending")]
		public void WhenTheListIsSortedDescending()
		{
			_list.CycleSortDescending<int>(Comparer<int>.Default);
		}
